...
public abstract class FirebaseRAdapter<ViewHolder extends RecyclerView.ViewHolder, T> extends RecyclerView.Adapter<ViewHolder> {
     ...
     */
    public FirebaseRAdapter(Query query) {
